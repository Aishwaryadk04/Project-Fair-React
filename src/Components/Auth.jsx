               ...
               <div className="card shadow p-5 bg-success">
                  <div className="row align-items-center">
                      <div className="col-lg-6">
                        <img src="https://img.freepik.com/premium-vector/home-office-concept-girl-working-table-with-laptop-green-cloth_274287-318.jpg" className='rounded w-100' alt="auth Image" />
                      </div>
                      <div className="col-lg-6">
